...
public class UserServiceImpl extends UserServiceImplBase {
  ...
  public void createUser(
      final CreateUserDto request, final StreamObserver<UserDto> responseObserver) {
  ...
  public void findUserById(
      final UserIdDto request, final StreamObserver<UserDto> responseObserver) {
    validationService.validate(request);
  ...
  public void findUserByEmail(
      final UserEmailDto request, final StreamObserver<UserDto> responseObserver) {
    validationService.validate(request);
  ...
  @Override
  public void updateUser(final UserDto request, final StreamObserver<UserDto> responseObserver) {
    validationService.validate(request);
    var userId = request.getId();
